...
function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-indigo-600 to-purple-700 text-white">
      ...
      <nav className="flex justify-between items-center px-10 py-6">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="px-5 py-2 rounded-lg bg-white text-indigo-600 font-semibold hover:bg-gray-100 transition"
          >
            Sign Up
          </button>
        </div>
